package com.cyl.storm.itcast.reliability;
...
public class MessageSpout implements IRichSpout {
	...
	public MessageSpout() {
		lines = new String[] { "0,zero", "1,one", "2,two", "3,three", "4,four",
	...
	public void ack(Object msgId) {
		System.out
				.println("message sends successfully (msgId = " + msgId + ")");
	}

	@Override
	public void fail(Object msgId) {
		System.out.println("error : message sends unsuccessfully (msgId = "
				+ msgId + ")");
